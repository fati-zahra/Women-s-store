<?php
    // here we chek if a selected product is added to the cart or no
    function check_if_added_to_cart($item_id){
        require 'connection.php';
        $user_id=$_SESSION['id'];
        // select all products from users_items table that have the same item_id and the same user_id
